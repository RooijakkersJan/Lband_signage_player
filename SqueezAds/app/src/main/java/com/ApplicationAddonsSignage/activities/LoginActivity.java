...
import com.ApplicationAddonsSignage.utils.AlertDialogManager;
import com.ApplicationAddonsSignage.utils.Constants;
import com.ApplicationAddonsSignage.utils.SharedPreferenceUtil;
import com.ApplicationAddonsSignage.utils.SignalRActivate;
...
public class LoginActivity extends Activity implements View.OnClickListener,
    ...
    public static LoginActivity statlogin;
    SignalRActivate signalactivate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            statlogin=this;
            qrScanimg = findViewById(R.id.image_qr_code);
...
//        edit_username.setText("In-Mohali");
    ...
    protected void onStart() {
        ...
        String strhtv="https://signalr.htvled.com/pushNotification";
        String portalsmc="https://app.smartmediacontrol.com/#/player-activate/";
        String portalhtv="https://app.htvled.com/#/player-activate/";
        String portallcd="https://lcdmediadenmark.com/#/player-activate/";

        signalactivate=new SignalRActivate(strsmc,context);
        String sessionToken = portalsmc+Utilities.getDeviceID(context);
    ...
    protected void onUserLeaveHint() {
        ...
        if(signalactivate!=null)
        {
            //signalactivate.stop();
        }
    }

    private void generateQrCode(String dataToEncode) {
        MultiFormatWriter multiFormatWriter = new MultiFormatWriter();
        try {
            // Encode the string data into a 500x500 pixel matrix
            ...
            // Convert the matrix data directly into a renderable Android Bitmap
            BarcodeEncoder barcodeEncoder = new BarcodeEncoder();
            Bitmap qrBitmap = barcodeEncoder.createBitmap(bitMatrix);

            // Set the generated image directly to your UI layout component
            qrScanimg.setImageBitmap(qrBitmap);
    ...
    private void handleCheckDeviceIdResponse(String response){
        ...
        try{
            ...
            if (Response.equals("1")){
                ...
                String width=new JSONArray(response).getJSONObject(0).getString("screenWidthpx");
                String height=new JSONArray(response).getJSONObject(0).getString("screenHeightpx");
                ...
                SharedPreferenceUtil.setStringPreference(context, AlenkaMediaPreferences.Width_Box,width);
                SharedPreferenceUtil.setStringPreference(context, AlenkaMediaPreferences.Height_box,height);
