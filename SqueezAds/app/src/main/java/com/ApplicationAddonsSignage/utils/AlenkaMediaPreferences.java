...
/**
 * Created by ParasMobileApp on 6/16/2016.
 */
public class AlenkaMediaPreferences {
    ...
    public static final String Width_Box = "width";

    public static final String Height_box= "height";

    public static final String LoginSuccess = "login";
    public static final String ShowPopuptime = "popuptime";
    public static final String DaysPlayerExpire = "leftdays";
    public static final String Popupactivation = "activation";
    public static final String Popupdismiss = "popdismiss";
