package com.ApplicationAddonsSignage.custom_views;
...
public class Lvideoads extends TextureView implements TextureView.SurfaceTextureListener,
    ...
    Lvideoads.OnMediaCompletionListener onMediaCompletionListener = null;
    ...
    public Lvideoads(Context context) {
        super(context);
        setSurfaceTextureListener(this);
    }

    public Lvideoads(Context context, AttributeSet attrs) {
        super(context, attrs);
        setSurfaceTextureListener(this);
    }
    ...
    public void setOnMediaCompletionListener(Lvideoads.OnMediaCompletionListener listener){
        this.onMediaCompletionListener = listener;
    }

    public void setonloop(boolean val)
    {
        if(mediaPlayer!=null)
        {
    ...
    public void getDurationlengthvise()
    {
        mediaPlayer.getDuration();
    }

    public void getCurrentPositionVideo()
    {
