...
public class MySQLiteHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_Instant_SONGS = "instantsongs";
    ...
    //TODO: Colums for Instant Data
    public static final String COLUMN_Instant_TITLE_ID = "title_id";
    public static final String COLUMN_Instant_IS_DOWNLOADED = "is_downloaded";
    public static final String COLUMN_Instant_SONG_PATH = "song_path";
    public static final String COLUMN_Instant_TITLE_URL = "song_url";
    public static final String COLUMN_Instant_SERIAL_NO = "serial_no";
    public static final String COLUMN_Instant_FileSize = "filesize";
    public static final String COLUMN_Instant_TimeInterval = "timeinterval";
    public static final String COLUMN_Instant_Mediatype = "mediatype";

    public static final String COLUMN_Instant_Title = "title";
    ...
    private static final String DATABASE_CREATE_Instant_SONGS = "create table "
            + TABLE_Instant_SONGS + "(" + COLUMN_ID
            + " integer primary key autoincrement, " + COLUMN_SCHID
            + " text not null, " + COLUMN_Instant_TITLE_ID
            + " text not null, " + COLUMN_Instant_IS_DOWNLOADED
            + " text not null, " + COLUMN_SP_PLAYLIST_ID
            + " text not null, " + COLUMN_Instant_SONG_PATH
            + " text not null, " + COLUMN_Instant_FileSize
            + " text not null, " + COLUMN_Instant_TimeInterval
            + " text not null, " + COLUMN_Instant_Mediatype
            + " text not null, " + COLUMN_Instant_Title
            + " text not null, " + COLUMN_Instant_TITLE_URL
            + " text not null, " + COLUMN_Instant_SERIAL_NO
            + " numeric not null);";
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        database.execSQL(DATABASE_CREATE_Instant_SONGS);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        Log.w(MySQLiteHelper.class.getName(),
                "Upgrading database from version " + oldVersion + " to "
                        + newVersion + ", which wil" +
                        "l destroy all old data");
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_PLAYLIST);
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_SONGS);
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_Instant_SONGS);
