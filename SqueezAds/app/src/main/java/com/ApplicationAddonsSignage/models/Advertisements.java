package com.ApplicationAddonsSignage.models;
...
public class Advertisements implements Serializable {
    ...
    public long getEnd_Adv_Time_Millis() {
        return end_Adv_Time_Millis;
    }

    public void setEnd_Adv_Time_Millis(long end_Adv_Time_Millis) {
        this.end_Adv_Time_Millis = end_Adv_Time_Millis;
    }

    public long getbtStart_Adv_Time_Millis() {
        return btstart_Adv_Date_Millis;
    }

    public void setbtstart_Adv_Time_Millis(long btstart_Adv_Date_Millis) {
        this.btstart_Adv_Date_Millis = btstart_Adv_Date_Millis;
    }
    private long end_Adv_Date_Millis;
    private long start_Adv_Time_Millis;
    private long end_Adv_Time_Millis;
    private long btstart_Adv_Date_Millis;
