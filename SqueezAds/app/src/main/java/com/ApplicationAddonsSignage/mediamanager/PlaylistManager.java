package com.ApplicationAddonsSignage.mediamanager;
...
import com.ApplicationAddonsSignage.activities.Splash_Activity;
...
import com.ApplicationAddonsSignage.database.PlaylistDataSource;
import com.ApplicationAddonsSignage.database.SongsDataSource;
...
//                    modalSongList.add(modal);
    ...
    public ArrayList<Playlist> getplaylistwithid(String id) {
        ...
        try {
            ...
            arrayList = playlistDataSource.getPlaylistSpecificid(id);
